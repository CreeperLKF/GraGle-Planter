...
timeSleepMin, timeSleepMax = 1, 3
defaultAddress = "translate.google.cn" # you can choose .com , .cn or something else if available
availableTTSLanguage = ("sq", "ar", "et", "is", "pl", "bs", "af",\
...
availableTranslationLanguage = {'hi': '印地语', 'ps': '普什图语', 'pt': '葡萄牙语', 'hmn': '苗语',\
    ...
    # 'auto': '检测语言' is not contained but cannot be target language 